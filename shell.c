...
/*  
    * будет добавлено: 
    *   пришление ввода с текущим именем пользователя и текущей директорией (пример: alex@SHELL:/home/alex/ -> )
    *   история команд
    *   красивый вывод --help
    *   файл конфигурации .shellrc
    *   логирование (запись всех веденных команд в файл ~/.shell_history)
*/  
